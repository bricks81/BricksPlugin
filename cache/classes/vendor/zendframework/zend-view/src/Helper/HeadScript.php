...
/*@referenced-file:(K:\Bricks\Application\vendor\zendframework\zend-view\src\Helper\HeadScript.php)*/
/**
...
class HeadScript extends Placeholder\Container\AbstractStandalone
{
    ...
    public function itemToString($item, $indent, $escapeStart, $escapeEnd)
    {
        ...
        $response = isset($GLOBALS['BricksPlugin/EventManager']) ? $GLOBALS['BricksPlugin/EventManager']->trigger(__METHOD__ . '.pre', $this, $params) : false;
        if ($response && $response->stopped()) {
            return $response->last();
        }
        $call = function ($item, $indent, $escapeStart, $escapeEnd) {
            $attrString = '';
            if (!empty($item->attributes)) {
                foreach ($item->attributes as $key => $value) {
                    if (!$this->arbitraryAttributesAllowed() && !in_array($key, $this->optionalAttributes) || in_array($key, array('conditional', 'noescape'))) {
                        continue;
                    }
                    if ('defer' == $key) {
                        $value = 'defer';
        ...
        $return = $call($item, $indent, $escapeStart, $escapeEnd);
        $params = get_defined_vars();
        $response = isset($GLOBALS['BricksPlugin/EventManager']) ? $GLOBALS['BricksPlugin/EventManager']->trigger(__METHOD__ . '.post', $this, $params) : false;
