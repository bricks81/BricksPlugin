...
/*@referenced-file:(K:\Bricks\Application\vendor\zendframework\zend-view\src\Helper\HeadLink.php)*/
/**
...
class HeadLink extends Placeholder\Container\AbstractStandalone
{
     ...
     * @var string[]
     */
    protected $itemKeys = array('charset', 'href', 'hreflang', 'id', 'media', 'rel', 'rev', 'sizes', 'type', 'title', 'extras', 'itemprop');
    /**
