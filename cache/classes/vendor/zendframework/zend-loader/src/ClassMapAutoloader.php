...
/*@referenced-file:(K:\Bricks\Application\vendor\zendframework\zend-loader\src\ClassMapAutoloader.php)*/
/**
...
require_once 'K:\\Bricks\\Application\\vendor\\zendframework\\zend-loader\\src' . '/SplAutoloader.php';
/**
...
class ClassMapAutoloader implements SplAutoloader
{
    ...
    public function registerAutoloadMap($map)
    {
        ...
        if (!is_array($map)) {
            require_once 'K:\\Bricks\\Application\\vendor\\zendframework\\zend-loader\\src' . '/Exception/InvalidArgumentException.php';
